...
API.chatLog("[ BalkanBOT ] LAST UPDATED: 04.09.2014", true);
...
name: "BalkanBot",
loggedInID: null,
scriptLink: "http://www.balkan-party.tk/files/theme/balkanBOTv2.js",
...
if (bBot.settings.songstats) API.sendChat("/me " + lastplay.media.author + " - " + lastplay.media.title + ": " + lastplay.score.positive + "W/" + lastplay.score.grabs + "G/" + lastplay.score.negative + "M.")
...
var joinedroulette = bBot.chat.roulettejoin.split('%%NAME%%');
if(joinedroulette[1].length > joinedroulette[0].length) joinedroulette = joinedroulette[1];
else joinedroulette = joinedroulette[0];
var leftroulette = bBot.chat.rouletteleave.split('%%NAME%%');
...
API.sendChat("/me This will help you a little:, {link: link} ");
}
}
},
joinCommand: {
...
return API.sendChat(subChat(bBot.chat.lockguardtime, {name: chat.un, position: bBot.settings.maximumLocktime}));
}
else return API.sendChat(subChat(bBot.chat.invalidtime, {name: chat.un}));
}
}
...
API.sendChat('/me Edited by: ' + botCreator + '.');
}
}
},
statusCommand: {
